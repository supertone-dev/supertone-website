  ...
  return (
    <>
      <div className={`flex flex-col w-screen ${formIsOpen ? "hidden" : ""}`}>
        <header className="w-full h-16 flex justify-center items-center mb-8">
          <div className="w-3/4 flex justify-between items-center">
            <div className="text-2xl md:text-4xl font-futuraBold font-bold">
              Supertone
            </div>
        ...
        <main className="h-full w-full flex flex-col justify-center items-center">
          <div className="w-1/2 text-center">
            <p className="text-4xl md:text-6xl font-minion font-bold text-gray-900 my-4">
          ...
          <button
            onClick={onClick}
            className="bg-gray-900 text-white rounded-md px-4 py-2 my-5"
          >
            Get early access
          </button>
